...
insert  into `pelanggan`(`plgnId`,`plgnKode`,`plgnNama`,`plgnNamaKontak`,`plgnTelp1`,`plgnTelp2`,`plgnAlamat`,`plgnPiutang`,`plgnNik`,`plgnNamaUser`,`plgnPassword`,`plgnEmail`) values (1,'P001','CV Langkah Prima','-','0','0','-',0,'-','langkahprima','123','-'),(2,'P002','WTL','-','0','0','-',0,'-','wtl','123','-'),(3,'P003','Gunawan Arifin','-','0','0','-',0,'-','gunawanarifin','123','-'),(4,'P004','PT. TELADAN LANGGENG JAYA','-','0','0','-',0,'-','teladanlanggeng','123','-'),(5,'P005','CV. Tiga Tata Niaga','-','0','0','-',0,'-','Tiga Tata Niaga','123','-'),(6,'P006','Tunai','-','0','0','0',0,'-','tunai','123','-');
