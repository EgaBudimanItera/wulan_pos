                ...
                <form action="<?=base_url()?>c_users/ubah_users/<?=$users->userId?>" role="form" method="post" class="form-horizontal">
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       ...
                       <input type="text" class="span6" id="userNama" required name="userNama" value="<?=$users->userNama?>" readonly/>
                  ...
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       <input type="text" name="userHakAkses" value="<?=$users->userHakAkses?>" readonly>
                       <span class="help-inline"></span>
                    </div>
                  </div>
