          ...
          <div class="span12">
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                ...
                <br>
                <form action="<?=base_url()?>c_satuan/ubah_satuan/<?=$satuan->stunId?>" role="form" method="post" class="form-horizontal">
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       ...
                       <input type="text" class="span6" id="stunNama" required name="stunNama" value="<?=@$satuan->stunNama?>" />
                  ...
                  <div class="control-group primary">
                    ...
                    <div class="controls">
                       <input type="text" class="span6" id="stunSimbol" required name="stunSimbol" value="<?=@$satuan->stunSimbol?>"/>
                       <span class="help-inline"></span>
                    </div>
                  </div>
