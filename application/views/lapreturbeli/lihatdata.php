              ...
              <div class="widget-body">
               <div id="info-alert"><?=@$this->session->flashdata('msg')?></div>
                <div>
                  ...
                  <a href="<?=base_url()?>c_lapreturbeli/cetak/<?=$daritanggal?>/<?=$hinggatanggal?>/<?=$splrId?>" class="btn btn-warning" target="_blank"><i class="icon-print"></i> Cetak</a>
                </div>
              </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">No Faktur Pembelian</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$l->drpbJumlah;?></td>
                    <td><?=$l->drpbHarga;?></td>
                    <td><?=$l->drpbHarga*$l->drpbJumlah;?></td>
                  </tr>
                  <?php
                    $total=$total+($l->drpbHarga*$l->drpbJumlah);
