    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="#">Laporan Retur Pembelian</a><span class="divider-last">&nbsp;</span></li>
        </ul>
          ...
          <div class="span12">
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                ...
                <form action="<?=base_url()?>c_lapreturbeli/lihat" role="form" method="post" class="form-horizontal">
